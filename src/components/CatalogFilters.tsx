...
import { Search, Filter, ArrowUpDown, X, Tv, Film, Sparkles, SlidersHorizontal } from 'lucide-react';
...
export const CatalogFilters: React.FC<CatalogFiltersProps> = ({
  ...
  const hasActiveFilters = searchQuery !== '' || selectedType !== 'ALL' || selectedGenre !== 'Todos' || sortBy !== 'curated';
  ...
  return (
    <div className="bg-[#070e12] border border-[#142631] p-4 sm:p-6 rounded-sm space-y-5 shadow-xl">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="relative flex-1 max-w-xl">
          ...
          <input
            ...
            type="text"
            placeholder="Buscar por título, elenco, diretor ou tema..."
            value={searchQuery}
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <option value="curated">Ordem da Curadoria</option>
